...
class PlayScene extends Phaser.Scene {
  ...
  private gameOver() {
    ...
    // Start reliable fade-to-black effect
  ...
  private showGameOverScreen() {
    ...
    if (this.spawnTimer) { try { this.spawnTimer.destroy() } catch {} ; (this as any).spawnTimer = undefined }
    if (this.collectibleTimer) { try { this.collectibleTimer.destroy() } catch {} ; (this as any).collectibleTimer = undefined }
    if (this.enemyTimer) { try { this.enemyTimer.destroy() } catch {} ; (this as any).enemyTimer = undefined }
    if (this.freezeTimer) {
      this.freezeTimer.destroy()
    }
